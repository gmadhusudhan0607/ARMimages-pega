...
description =  "Used to register GenAIGatewayService Side in SAX"
...
sar {
    name = "GenAIGatewayServiceSaxRegistration"
    description = "Used to register GenAIGatewayService Side in SAX (Service)"
