module github.com/Pega-CloudEngineering/gen-ai-vector-store
...
require (
	...
	github.com/Pega-CloudEngineering/go-sax v1.3.11
...
replace github.com/pashagolub/pgxmock/v3 v3.2.0 => github.com/makubit/pgxmock/v3 v3.0.0-20240118160136-3dc17867dfd2
...
require (
	...
	github.com/medyagh/gopogh v0.29.0 // indirect
...
tool (
	github.com/golangci/golangci-lint/v2/cmd/golangci-lint // Add /v2
	github.com/medyagh/gopogh/cmd/gopogh
