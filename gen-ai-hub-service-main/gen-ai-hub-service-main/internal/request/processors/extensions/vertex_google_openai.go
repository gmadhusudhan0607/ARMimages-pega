...
// VertexGoogleOpenAIExtension provides Azure OpenAI API 2024-10-21 specific processing
type VertexGoogleOpenAIExtension struct {
}

// NewVertexGoogleOpenAIExtension creates a new Azure OpenAI 2024-10-21 extension
func NewVertexGoogleOpenAIExtension() *VertexGoogleOpenAIExtension {
	return &VertexGoogleOpenAIExtension{}
}

// GetConfiguration returns the configuration for Azure OpenAI 2024-10-21 processing
func (e *VertexGoogleOpenAIExtension) GetConfiguration() ExtensionConfiguration {
...
func (e *VertexGoogleOpenAIExtension) ParseStreamingResponse(responseBody []byte) (*ProcessedResponse, error) {
...
func (e *VertexGoogleOpenAIExtension) parseSSELine(line string) (map[string]interface{}, bool, error) {
...
func (e *VertexGoogleOpenAIExtension) extractFinishReason(chunk map[string]interface{}, result *ProcessedResponse) {
...
func (e *VertexGoogleOpenAIExtension) extractTokenUsage(chunk map[string]interface{}, result *ProcessedResponse) {
...
func (e *VertexGoogleOpenAIExtension) ValidateProcessingConfig(config *ProcessingConfig) error {
	if config == nil {
