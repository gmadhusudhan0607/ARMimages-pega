---
name: rubber-duck
description: "Pre-implementation design validation. Use when starting a new task, feature, or change and you need help creating a complete specification before diving into implementation. Surfaces overlooked risks like schema migration issues, HNSW rebuild costs, breaking changes, or deployment strategy."
tools:
  - read
  - search
---
