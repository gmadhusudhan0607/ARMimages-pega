...
func TestTimeout(t *testing.T) {
	...
	RunSpecs(t, "Request Timeout and Background Processing Suite")
}
...
var _ = BeforeSuite(func() {
	...
	// 5. Start background service first to update database schema, then keep it running for async processing
	...
	backgroundServiceEnv := map[string]string{
		...
		"EMBEDDING_QUEUE_MAX_RETRY_COUNT":  "3", // Use small value for faster test execution
	}
