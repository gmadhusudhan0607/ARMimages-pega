...
- **Writing test code**: Developers write all test code. QA agents may create ad-hoc helper scripts/tools to assist testing — these are NOT checked into the repo.
