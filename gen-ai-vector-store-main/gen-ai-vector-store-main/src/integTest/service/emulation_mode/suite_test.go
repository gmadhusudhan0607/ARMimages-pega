...
func TestIntegration(t *testing.T) {
	...
	RunSpecs(t, "Service Emulation Mode Suite")
}
...
var _ = AfterSuite(func() {
	...
	// Validate endpoint coverage for Emulation mode tests
	swaggerSpecURI := fmt.Sprintf("%s/", svcBaseURI)
	ExpectAllServiceEndpointsTestedForEmulationMode(swaggerSpecURI)
