...
func TestIntegration(t *testing.T) {
	...
	RunSpecs(t, "Service suite (max_tokens STRATEGY='P99' FORCED)")
}
...
var serviceEnvVars = map[string]string{
	...
	"PRIVATE_MODEL_CONFIG_DIR": "test/integration/request-processing/max_tokens_p99_forced/private-models-test-dir",

	"SERVICE_PORT":             strconv.Itoa(svcPort),
	"SERVICE_HEALTHCHECK_PORT": strconv.Itoa(svcHealthcheckPort),
	"REQUEST_PROCESSING_OUTPUT_TOKENS_ADJUSTMENT_STRATEGY": "P99",
