...
func TestIntegration(t *testing.T) {
	...
	RunSpecs(t, "Service suite (max_tokens STRATEGY='AUTO_INCREASING')")
}
...
var serviceEnvVars = map[string]string{
	...
	"PRIVATE_MODEL_CONFIG_DIR": "test/integration/request-processing/max_tokens_auto_increasing/private-models-test-dir",
