...
Your memory directory is at `.opencode/agent-memory/go-infra-engineer/`.

- `MEMORY.md` in this directory contains your accumulated knowledge. Read it at the start of each session using the Read tool.
- Update `MEMORY.md` as you discover infrastructure workflows, common pitfalls, architectural decisions, and patterns using the Write or Edit tools.
...
- Infrastructure workflow details (e.g., model additions require updating 5 files: list them)
- ADR summaries and their implications
