...
func TestIntegration(t *testing.T) {
	...
	RunSpecs(t, "Service suite (max_tokens STRATEGY='FIXED')")
}
...
var serviceEnvVars = map[string]string{
	...
	"PRIVATE_MODEL_CONFIG_DIR": "test/integration/request-processing/max_tokens_fixed/private-models-test-dir",
