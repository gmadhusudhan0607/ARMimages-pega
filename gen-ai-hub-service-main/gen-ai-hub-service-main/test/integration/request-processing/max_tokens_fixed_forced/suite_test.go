...
func TestIntegration(t *testing.T) {
	...
	RunSpecs(t, "Service suite (max_tokens STRATEGY='FIXED' FORCED)")
}
...
var serviceEnvVars = map[string]string{
	...
	"PRIVATE_MODEL_CONFIG_DIR": "test/integration/request-processing/max_tokens_fixed_forced/private-models-test-dir",
