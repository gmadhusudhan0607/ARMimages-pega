...
func TestIntegration(t *testing.T) {
	...
	RunSpecs(t, "Service suite (max_tokens STRATEGY='FIXED' STREAMING)")
}
...
var serviceEnvVars = map[string]string{
	...
	"PRIVATE_MODEL_CONFIG_DIR": "test/integration/request-processing/aliases/private-models-test-dir",
